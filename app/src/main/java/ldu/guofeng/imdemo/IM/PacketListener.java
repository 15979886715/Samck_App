...
public class PacketListener implements StanzaListener {
    ...
    public void processStanza(Stanza packet) throws SmackException.NotConnectedException, InterruptedException, SmackException.NotLoggedInException {
        ...
        Log.e(TAG, "后台返回来的数据PacketListener类30行行" + String.valueOf(packet.toXML("")));
        //表示接收到是消息包
...
//                    msg.setTo(Constant.TO);//设置包的发送去处
                ...
                case groupchat://表示收到群聊包
                    String msgBody2 = ((Message) packet).getBody();
                    Log.e(TAG, "接收到的一个群消息: " + msgBody2 );
